...
// Navigation extension for the Cash Registry plugin
const navigationExtension = {
  initialize: (plugin: Plugin) => {
    console.log('Cash Registry navigation initialized for plugin:', plugin.id);
    ...
    const navPath = '/cash-registry';
    const navId = 'cash-registry-main';
    ...
    console.log('Cash Registry navigation registered with ID:', extensionId);
    
    // Optional cleanup function
    return async () => {
      console.log('Cash Registry navigation cleanup');
    };
  }
};

console.log('Cash Registry navigation extension module loaded');
