...
const navigationExtension = {
  initialize: (plugin: Plugin) => {
    console.log('Records navigation initialized for plugin:', plugin.id);
    ...
    const navPath = '/records';
    const navId = 'records-main';
    ...
    console.log('Records navigation registered with ID:', extensionId);
    
    // Optional cleanup function
    return async () => {
      console.log('Records navigation cleanup');
    };
  }
};

console.log('Records navigation extension module loaded');
